<html>
    ...
    <body>
        ...
        <section id="lobby" style="background-image: url('assets/img/mars background 2.jpeg'); background-size: cover; background-repeat: no-repeat;">
            ...
            <div class="btn" onclick="location.href='mars-m3-online.html'" style="background-image: url('assets/img/button_lobby.svg'); background-size: cover; background-repeat: no-repeat;">
        ...
        <section id="lose" style="background-image: url('assets/img/lose bg.jpg'); background-size: cover; background-repeat: no-repeat;">
            ...
            <div class="add-cont">
                ...
                <div class="replay-btn" onclick="location.href='mars-m3-online.html'" style="background-image: url('assets/img/circle button.svg'); background-size: cover; background-repeat: no-repeat;">
        ...
        <section id="win" style="background-image: url('assets/img/win bg.png'); background-size: cover; background-repeat: no-repeat;">
            ...
            <div class="btn-cont">
                <div class="btn-win" onclick="location.href='mars-m3-online.html'" style="background-image: url('assets/img/button_win.svg'); background-size: cover; background-repeat: no-repeat;">
